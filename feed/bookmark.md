...
### [[2111.12417] NÜWA: Visual Synthesis Pre-training for Neural visUal World creAtion](http://arxiv.org/abs/2111.12417)


  This paper presents a unified multimodal pre-trained model called NÜWA that
...
the computational complexity. We evaluate NÜWA on 8 downstream tasks.
Compared to several strong baselines, NÜWA achieves state-of-the-art results
...
orders cannot be naïvely applied to analyze GPU kernels because of the
